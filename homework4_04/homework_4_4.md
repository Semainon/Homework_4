### Д3 4.3. ННаписать docker-compose.yaml, который реализует Grafana. Данные в TSDB этой Grafana-ы наполняются из значений метрик PostgreSQL из задания выше.

### Общая структура файловВ проекта, исходя из пунктов 1-6 ДЗ №4
```bash
...
– Введите имя пользователя admin и пароль, который выше установили.

Добавление источника данных:

– Переходим в раздел Connections в боковом меню;
– Добавить источник данных --> Add data source;
